...
import WhyLoveOriginss from '../components/WhyLoveOriginss';
import HowToUses from '../components/HowToUses';
import FixedProductBar from '../components/FixedProductBar';
import OfferComponent from '../components/OfferComponent';
import CheckoutPopup from '../components/CheckoutPopup';

const LandingPage = ({ proid }) => {
  const id = proid;
  ...
  const handleBuyNow = async (e) => {
    ...
    // Show checkout popup instead of navigating
